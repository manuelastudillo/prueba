...
class SWT_Popular_Posts_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array( 'classname' => 'SWT_Popular_Posts_Widget', 'description' => __( "Displays most popular Posts.", 'tb' ) );
		parent::WP_Widget( 'SWT_Popular_Posts_Widget', __( ' SWT - Popular Posts', 'tb' ), $widget_options );					
	...
	public function form( $instance ) {
		...
		<p class="widget-select-container">
 			<label for="<?php echo $this->get_field_id( 'categories' ); ?>"><?php _e( 'Choose Categories:', 'tb' ); ?></label>		
